      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8">
        {[
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className={`relative overflow-hidden bg-gradient-to-br ${btn.gradient} backdrop-blur-md rounded-2xl p-4 sm:p-6 flex flex-col items-center justify-center shadow-2xl border border-white/30`}
          >
            <div className="absolute inset-0 bg-white/10 opacity-0 hover:opacity-100 transition-opacity" />
            <btn.icon className="w-10 h-10 sm:w-12 sm:h-12 mb-2 drop-shadow-lg" />
            <span className="font-bold text-lg sm:text-xl tracking-wider">{btn.label}</span>
          </motion.button>
        ))}
      </div>
