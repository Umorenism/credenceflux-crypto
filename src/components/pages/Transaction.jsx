...
//                              overflow-hidden mb-5 shadow-md dark:shadow-lg transition-all"
//                 >
...
//                         <p className="font-mono text-gray-800 dark:text-orange-200/90 break-all mt-1">
//                           {tx.from}
//                         </p>
//                       </div>
//                       <div>
...
//                                    bg-gray-50 dark:bg-gray-950/70 px-5 sm:px-6 py-5"
//                       >
//                         <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
//                           Transaction Hash / Reference
//                         </p>
//                         <p className="font-mono text-gray-800 dark:text-orange-200 text-sm break-all">
//                           {tx.txid}
//                         </p>
//                       </motion.div>
//                     )}
